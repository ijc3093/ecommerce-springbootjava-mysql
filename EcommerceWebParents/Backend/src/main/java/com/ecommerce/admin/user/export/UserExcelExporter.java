...
import com.ecommerce.admin.user.AbstractExporter;
...
public class UserExcelExporter extends AbstractExporter{
	...
	private void writeHeaderLine() {
		...
		createCell(row, 1, "Photo", cellStyle);
...
//			createCell(row, columnIndex++, user.getPassword(), cellStyle);
//			createCell(row, columnIndex++, user.getPhotosImagePath(), cellStyle);
